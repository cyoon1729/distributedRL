...
class Learner:
    ...
    def __init__(self, config, buffer_remote, param_server, save_dir):
        ...
        for target_param, param in zip(self.policy.parameters(),
    ...
    def update_param_server(self):
        ...
        for param in self.param_list:
            params.append(state_dict[param].detach().numpy())
    ...
    def run(self):
        ...
        while self.update_step < self.num_train_steps:
            ...
            # log
            logging = {'update_step': self.update_step, 'q_loss': q_loss, 'policy_loss': policy_loss, 'td_error': td_error}
